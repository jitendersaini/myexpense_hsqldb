...
function checkEmpty(o, n) {
	if ($("select[name='category.id']").val() == null) {
		o.addClass("ui-state-error");
		updateTips(n + " field can not be empty.");
		return false;
	} else {
...
function populateDialog() {
	...
	var title = $("#expenseTitle"), value = $("#expenseValue"), date = $("#expenseDate"), category = $("#category.id"),
...
function edit(action) {
	...
	if (id == undefined) {
		...
		action += id + '&expenseTitle=' + expTitle + '&expenseValue='
				+ expValue + '&category.categoryName=' + expCategory +'&category.id=' + categoryId 
				+ '&expenseDate=' + expDate + '&createdDate=' + expCreatedDate+'&usersByCreatedBy.id='+createdById+'&paymentMode.id='+paidViaId;
