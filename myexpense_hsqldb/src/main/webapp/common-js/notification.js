...
function populateDialog() {
	...
	var notifyTitle = $("#notifyTitle"), notifyDays = $("#notifyDays"),notifyStartDate = $("#notificationStartDate"),notifyEndDate = $("#notificationEndDate"),
...
function populateDialogEdit() {
	...
	var notifyTitle = $("#notificationTitle"), notifyDays = $("#notifyDays"),notifyStartDate = $("#notificationStartDate"),notifyEndDate = $("#notificationEndDate"),
	...
	if (id == undefined) {
		...
		if(notifyVia=='Email') {
			...
			notifyVia = 3;
				...
				action += id + '&notificationTitle=' + notifyTitle + '&notifyDays='
				+ notifyDays + '&notifyVia=' + notifyVia + '&notificationStartDate='
				+ notifyStartDate + '&notificationEndDate=' + notifyEndDate+'&category.id='+categoryId+'&createdDate='+createdDate+'&usersByCreatedBy.id='+createdById;		
