		...
		<c:forEach items="${list}" var="v" varStatus="status">						
			<tr class="${cssName[status.index]}">
				<td width="5%" align="center"><input type="checkbox" id="rdo" class="rdo" name="rdo"
					value="${v.id}"></td>
				<td style="width: 15%">${v.notificationTitle}</td>
				...
				<td align="center" style="width: 13%;"><input type="hidden" name="hidUserid" value="${v.usersByCreatedBy.id}"/><fmt:formatDate value="${v.notificationStartDate}" type="date"/></td>
				<td align="center" style="width: 13%;"><fmt:formatDate value="${v.notificationEndDate}" type="date"/></td>
				<td align="center" style="width: 10%;">${statusDescription[status.index]}</td>
				<td align="center" style="width: 10%;">${v.usersByCreatedBy.name}</td>
				<td align="center" style="width: 10%;">${v.usersByModifiedBy.name}</td>										
